...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Rinda Port | Home</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main className=" bg-white px-7 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-7 flex justify-between dark:text-white">
            <h1 className="font-sans font-bold text-xl">RIANDA PORT.</h1>
            <ul className="flex items-center">
              <li>
                <BsFillMoonStarsFill onClick={() => setDarkMode(!darkMode)} className=" cursor-pointer text-2xl" />
              </li>
              <li>
                <a className="bg-gradient-to-r from-blue-700 text-to-white-500 text-white dark:from-teal-400 px-4 py-2 border-none rounded-md ml-8" href="#">
                  Contact
                </a>
              </li>
            </ul>
